...
qbb3 = arcpy.Buffer_analysis(qins, "wbb", "12.49 Meters", "FULL", "ROUND", "LIST", "Stationtext")
qerz = arcpy.Erase_analysis(bnd, sf, "eraseOut")
qfaw = arcpy.Intersect_analysis ([qbb3, qerz], "FinalAllowed", "ALL", "", "")
qras1 = arcpy.FeatureToRaster_conversion(qfaw, "FID_wbb", "outras1", 5)
qras2 = arcpy.RasterToPoint_conversion(qras1, "outras2", "VALUE")
