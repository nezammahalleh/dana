...
arcpy.env.workspace = r"D:\Nezammahalleh\project_Nezammahalleh\MyProject3\vol7.gdb"
...
palw = arcpy.GetParameterAsText(5) #"w3"
wks = arcpy.GetParameterAsText(6) #r"D:\Nezammahalleh\project_Nezammahalleh\MyProject3\vol7.gdb"
finalmg = arcpy.GetParameterAsText(7) #final "merg12"
...
qras2 = arcpy.RasterToPoint_conversion(arcpy.FeatureToRaster_conversion(qfaw, "FID_xwbb", "xoutras1", 10), palw, "VALUE")
